...
class LocationEditDetails extends StatefulWidget {
  const LocationEditDetails(
      {Key? key,
      this.profileData,
      this.vendorName,
      this.ownerName,
  ...
  @override
  State<LocationEditDetails> createState() => _LocationEditDetailsState();
}

class _LocationEditDetailsState extends State<LocationEditDetails> {
  var uid;
  PlaceApiProvider? apiClient;
  DateTime? currentBackPressTime;
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final ProfileRepository _profileRepository = ProfileRepository();
  bool isSearching = false, isUpload = false;
              ...
              child: InkWell(
                ...
                child: Container(
                    decoration: BoxDecoration(
                        border: Border.all(color: Color(0xFF002434), width: 2),
  ...
  Future<void> getImageUploadDetails() async {
    ...
    try {
      ProfileModel profileData = await _profileRepository.vendorEditProfile(
          ...
          widget.vendorName!,
          widget.ownerName!,
          int.parse(widget.vendor_type!),
          int.parse(widget.contact2!),
          widget.storeAddress!,
          widget.gstNumber!,
          int.parse(pincode),
          state,
