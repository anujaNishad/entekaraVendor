        ...
        body: BlocProvider(
            ...
            child: SafeArea(
              child: Padding(
                ...
                child: Stack(
                  children: [
                    BlocListener<ManageTimingBloc, ManageTimingState>(
                      ...
                      child: BlocBuilder<ManageTimingBloc, ManageTimingState>(
                        ...
                        } else if (state is GetWorkingLoadedState) {
                          return state.manageTimeModel!.data!.length > 0
                              ? Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      state.manageTimeModel!.data![index].openingTime ==
                                                                              null
                                                                          ? 'Open Time:00:00'
                                                                    ...
                                                                    Text(
                                                                      state.manageTimeModel!.data![index].closingTime ==
                                                                              null
                                                                          ? 'Close Time:00:00'
